  ...
  return class {
    ...
    getGroupErrorMessage(e) {
      return (
        ...
        (e.rule === r.Required ? "The field is required" : "Group is incorrect")
      );
    }
        ...
        Object.keys(r).forEach((e) => {
          t.elems.forEach((i) => {
            ...
            (i.style[e] = ""),
              i.classList.remove(
                ...n(
                  (null == (s = t.config) ? void 0 : s.successFieldCssClass) ||
                    this.globalConfig.successFieldCssClass
                )
              );
          });
    ...
    renderTooltip(e, i, s) {
      ...
      const {
        ...
        d =
          s || (null == (t = this.globalConfig.tooltip) ? void 0 : t.position);
      switch (d) {
        case "left":
